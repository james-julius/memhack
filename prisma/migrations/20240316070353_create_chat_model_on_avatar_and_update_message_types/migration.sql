/*
  ...
  - The values [AI,USER] on the enum `MessageType` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "MessageType_new" AS ENUM ('user', 'assistant', 'system', 'function', 'data', 'tool');

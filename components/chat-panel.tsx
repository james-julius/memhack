...
export function ChatPanel({ id, title, input, setInput }: ChatPanelProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 w-full bg-gradient-to-b from-gradient-base from-0% to-gradient-accent to-50% duration-300 ease-in-out animate-in dark:from-background/10 dark:from-10% dark:to-background/80 peer-[[data-state=open]]:group-[]:lg:pl-[250px] peer-[[data-state=open]]:group-[]:xl:pl-[300px]">
